...
export const VerticalTitle = ({
  ...
  return (
    <aside className="sticky bottom-0 left-0 top-0 flex h-screen w-[40px] flex-shrink-0 items-center justify-center overflow-hidden bg-[#A86A45] lg:hidden xl:w-[90px] 2xl:w-[120px]">
