...
const ServiceCard = ({ item }: { item: ServiceCardType }) => {
  return (
    <div className="group relative flex h-auto w-[280px] shrink-0 flex-col items-center justify-center sm:w-[320px] md:w-[360px]">
      ...
      <div className="relative w-full overflow-hidden rounded-[24px] border border-[#A86A45]/20 bg-white p-[2px] shadow-[0_8px_32px_rgba(168,_106,_69,_0.1)] transition-all duration-500 hover:border-[#A86A45]/40 hover:shadow-[0_12px_48px_rgba(168,_106,_69,_0.2)] sm:rounded-[28px] md:rounded-[32px]">
        ...
        {/* Card Content */}
        <div className="relative flex w-full flex-col rounded-[22px] bg-gradient-to-br from-white to-[#FBF7F1] p-4 sm:rounded-[26px] sm:p-5 md:rounded-[30px] md:p-6">
